...
@if ($posts->count())
    ...
    {{-- Highlight Post --}}
    @if ($posts->onFirstPage() || request()->input('test') == 'test')
    ...
    <div class="container" style="padding: 0;">
        <div class="row mb-4">
            {{-- Start index at 1 if the page is the first page or 'test' is present --}}
            {{-- @php
                $idx = request()->page == 1 || request()->input('test') == 'test' ? 1 : 0;
            @endphp --}}
